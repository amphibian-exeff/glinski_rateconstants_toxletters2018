...
#summary(micro)
#micro.atrazine <- micro[which(micro$parent=="atrazine"),]
#micro.atrazine.atrazine <- micro.atrazine[which(micro.atrazine$analyte=="atrazine"),]
#micro.atrazine.dia <- micro.atrazine[which(micro.atrazine$analyte=="dia"),]
#micro.atrazine.dea <- micro.atrazine[which(micro.atrazine$analyte=="dea"),]
...
print(modelFit(model.atrazine.drm))
...
print(modelFit(model.triadimefon.drm))
...
print(modelFit(model.fipronil.drm))
...
print(modelFit(model.fipsulf.drm))
