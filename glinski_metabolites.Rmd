...
tested hypotheses
============
- observed vivo versus in vitro degradation rates are the same
- observed vivo rates are lower than in vitro rates (due to other degradation processes, uptake kinetics?)
...
import data
===========
Load csv file with experimental data. Do not yet have microsome data in csv format.
