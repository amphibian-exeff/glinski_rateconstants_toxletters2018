...
- what are conc units
picomoles/minute/mg protein
micromoles
general configuration
- how related are the replicates?
...
ggplot(mm, aes(x = sub, y = vel)) +
  ...
  ylab("Speed [picomoles/minute/mg protein]") +
